Ext.define('Project3.view.desktop.design.drawer.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Project3.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Project3.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Project3.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Project3.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Project3.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Project3.view.clouddrive.CloudDrive");
    },
