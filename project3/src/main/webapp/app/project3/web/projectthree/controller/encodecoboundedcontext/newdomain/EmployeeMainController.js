Ext.define('Project3.project3.web.projectthree.controller.encodecoboundedcontext.newdomain.EmployeeMainController', {
     ...
     onFilterClick: function(but, evt) {
          ...
          Ext.Ajax.request({
               ...
               failure: function(response, opts) {
                    ...
                    var compRef = currentView.down('#EmployeeTree');
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Project3.project3.shared.projectthree.model.encodecoboundedcontext.newdomain.EmployeeModel',
               autoLoad: true,
