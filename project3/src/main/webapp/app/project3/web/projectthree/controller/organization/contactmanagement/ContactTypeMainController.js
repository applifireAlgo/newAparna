Ext.define('Project3.project3.web.projectthree.controller.organization.contactmanagement.ContactTypeMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Project3.project3.shared.projectthree.model.organization.contactmanagement.ContactTypeModel',
               autoLoad: true,
