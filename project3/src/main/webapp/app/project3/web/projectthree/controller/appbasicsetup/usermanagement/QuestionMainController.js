Ext.define('Project3.project3.web.projectthree.controller.appbasicsetup.usermanagement.QuestionMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Project3.project3.shared.projectthree.model.appbasicsetup.usermanagement.QuestionModel',
               autoLoad: true,
