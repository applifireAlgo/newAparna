package projectthree.app.server.businessservice.appbasicsetup.userrolemanagement.aspect;
...
public class BusinessServiceuserrolemanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* projectthree.app.server.businessservice.appbasicsetup.userrolemanagement..*(..))")
