package projectthree.app.server.businessservice.organization.locationmanagement.aspect;
...
public class BusinessServicelocationmanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* projectthree.app.server.businessservice.organization.locationmanagement..*(..))")
