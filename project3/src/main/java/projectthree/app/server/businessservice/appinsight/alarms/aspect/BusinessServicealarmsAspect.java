package projectthree.app.server.businessservice.appinsight.alarms.aspect;
...
public class BusinessServicealarmsAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* projectthree.app.server.businessservice.appinsight.alarms..*(..)) && !alarmOperation()")
    protected void allOperation() {
    }

    @Pointcut("execution(* projectthree.app.server.businessservice.appinsight.alarms.AppLogAlarmGenerationBizService..*(..))")
