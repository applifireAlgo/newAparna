package projectthree.app.server.businessservice.appbasicsetup.usermanagement.aspect;
...
public class BusinessServiceusermanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* projectthree.app.server.businessservice.appbasicsetup.usermanagement..*(..))")
