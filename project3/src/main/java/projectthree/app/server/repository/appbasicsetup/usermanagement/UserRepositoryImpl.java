...
public class UserRepositoryImpl extends SearchInterfaceImpl implements UserRepository<User> {
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource();
        User object = emanager.find(projectthree.app.shared.appbasicsetup.usermanagement.User.class, id);
    ...
    public void deletePassRecovery(List<PassRecovery> passrecovery) {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        for (projectthree.app.shared.appbasicsetup.usermanagement.PassRecovery _passrecovery : passrecovery) {
            projectthree.app.shared.appbasicsetup.usermanagement.PassRecovery s = emanager.find(projectthree.app.shared.appbasicsetup.usermanagement.PassRecovery.class, _passrecovery.getPassRecoveryId());
            emanager.remove(s);
        }
    }
    ...
    public List<User> findByUserAccessLevelId(String userAccessLevelId) throws Exception {
        ...
        java.util.List<projectthree.app.shared.appbasicsetup.usermanagement.User> listOfUser = query.getResultList();
