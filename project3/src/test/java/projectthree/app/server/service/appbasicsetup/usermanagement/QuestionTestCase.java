...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionDetails("7exWP2XcAG");
        question.setQuestionIcon("UmuukCd3PpbSlLqdZvg0HaEKMeUN3HRhcDg03Xr59wNHWAYBsT");
        question.setLevelid(6);
        question.setQuestion("fIX4IXpjSlCdPI7bJyDlnozsyPeXcvXpthBT8ISlkIvu6rwzho");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionDetails("8AXFu3rWk4");
            question.setQuestionIcon("IitQQTTdZuc4LeAvNnP14E8ILmoITOLXnWRLjHJVvLCHeQkLbk");
            question.setVersionId(1);
            question.setLevelid(9);
            question.setQuestion("xW5hcsrv8wJyGRlL73Y3sxbtCqREyAOjr6omegIrp8xZbqZWe7");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "g5BaiH09uFyZvpQWgLGd6pFdNfFft665A3J62IQPNirFm8O4RhSyCF5RcUrhf3AoR"));
