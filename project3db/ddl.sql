...
DROP TABLE IF EXISTS `ast_Quest_T`;

CREATE TABLE `ast_Quest_T` ( `queId` VARCHAR(256) NOT NULL, `queName` VARCHAR(256) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`queId`));

DROP TABLE IF EXISTS `ast_Answer_T`;

CREATE TABLE `ast_Answer_T` ( `ansId` VARCHAR(256) NOT NULL, `ansName` VARCHAR(256) NOT NULL, `ansWei` INT(10) NULL DEFAULT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`ansId`));

DROP TABLE IF EXISTS `ast_QueAns_B`;

CREATE TABLE `ast_QueAns_B` ( `queansPkey` INT(11) NOT NULL AUTO_INCREMENT, `queId` VARCHAR(256) NOT NULL, `ansId` VARCHAR(256) NOT NULL, PRIMARY KEY (`queansPkey`));

DROP TABLE IF EXISTS `ast_Employee_M`;

CREATE TABLE `ast_Employee_M` ( `empId` VARCHAR(256) NOT NULL, `empName` VARCHAR(256) NOT NULL, `empSal` BIGINT(20) NULL DEFAULT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`empId`), UNIQUE KEY (`empName`));

DROP TABLE IF EXISTS `ast_Indian_M`;

CREATE TABLE `ast_Indian_M` ( `foodId` VARCHAR(256) NOT NULL, `foodName` VARCHAR(256) NOT NULL, `cuisineName` VARCHAR(256) NOT NULL, `foodType` VARCHAR(256) NOT NULL, `fromState` VARCHAR(64) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`foodId`));
...
ALTER TABLE `ast_QueAns_B` ADD CONSTRAINT FOREIGN KEY (`queId`) REFERENCES `ast_Quest_T`(`queId`);

ALTER TABLE `ast_QueAns_B` ADD CONSTRAINT FOREIGN KEY (`ansId`) REFERENCES `ast_Answer_T`(`ansId`);

ALTER TABLE `ast_Indian_M` ADD CONSTRAINT FOREIGN KEY (`fromState`) REFERENCES `ast_State_M`(`stateId`);
