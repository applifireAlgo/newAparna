 ...
 */
Ext.define('Newproject.Application', {
	...
	requires : [ "Ext.data.Model","Ext.app.ViewModel","Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Newproject.view.databrowsercalendar.DBCalendar",
			"Newproject.view.fw.component.CustomComboBox" ,"Newproject.view.fw.component.TreeComponent"],
	...
	stores : [ 'Newproject.store.QueryCriteriaWidgetsStore' ],
	...
	try{
		...
		if (responseText.alarm) {
			if (responseText.alarm.alarmID == "ABSAA254905401" && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Newproject.view.login.SessionLogin').center();
