Ext.define('Newproject.view.appreportui.querycriteria.QueryCriteriaPanelView',{
	extend : 'Ext.panel.Panel',
	requires : [ 'Newproject.view.appreportui.querycriteria.QueryCriteriaViewController' ],
