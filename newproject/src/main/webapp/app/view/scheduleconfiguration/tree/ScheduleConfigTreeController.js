 ...
 * 
 */
Ext.define("Newproject.view.scheduleconfiguration.tree.ScheduleConfigTreeController", {
	...
	onItemClick : function(view, record, item, index, e) {
		if (index > 0) {
			...
			if (!isPresent) {
				var component = Ext.create("Newproject.view.scheduleconfiguration.panel.ScheduleConfig", {
