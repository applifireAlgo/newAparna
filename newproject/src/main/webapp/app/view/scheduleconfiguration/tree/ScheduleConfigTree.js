 ...
 * 
 */
Ext.define("Newproject.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Newproject.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
