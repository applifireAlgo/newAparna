 ...
 * 
 */
Ext.define('Newproject.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Newproject.view.logalarm.mainscreen.AddLogAlarmController',
			'Newproject.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Newproject.view.logalarm.mainscreen.AppAlarmPanel',
