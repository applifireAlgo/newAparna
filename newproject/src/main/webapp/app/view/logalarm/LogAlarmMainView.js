 ...
 * 
 */
Ext.define('Newproject.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Newproject.view.logalarm.LogAlarmMainViewController',
			'Newproject.view.logalarm.tree.LogAlarmTreePanel',
			'Newproject.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
