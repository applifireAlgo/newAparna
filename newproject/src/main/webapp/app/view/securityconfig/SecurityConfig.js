 ...
 * 
 */
Ext.define('Newproject.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Newproject.view.securityconfig.SecurityConfigController',
			'Newproject.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
