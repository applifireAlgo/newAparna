 ...
 */
Ext.define('Newproject.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Newproject.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Newproject.view.fw.component.DateTimePicker(o);
    },
