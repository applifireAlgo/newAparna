Ext.define('Newproject.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Newproject.view.usermanagement.enduser.UserProfileController', 'Newproject.view.usermanagement.admin.AddUserDetailsViewModel', 'Newproject.model.AddUserDataModel' ],
