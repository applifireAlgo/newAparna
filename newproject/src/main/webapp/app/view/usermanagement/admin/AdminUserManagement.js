Ext.define('Newproject.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Newproject.view.usermanagement.admin.UserPasswordReset',
	            'Newproject.view.usermanagement.admin.AddUserDetails',
	            'Newproject.view.usermanagement.admin.ViewUser'],
