Ext.define('Newproject.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Newproject.view.usermanagement.admin.AddUserDetailsViewModel', 'Newproject.model.AddUserDataModel' ],
