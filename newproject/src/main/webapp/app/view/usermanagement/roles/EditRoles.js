Ext.define('Newproject.view.usermanagement.roles.EditRoles', {
	extend : 'Ext.panel.Panel',
	requires : [ 'Newproject.view.usermanagement.roles.EditRolesController', 'Ext.tree.plugin.TreeViewDragDrop' ],
