Ext.define('Newproject.view.desktop.design.drawer.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Newproject.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Newproject.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Newproject.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Newproject.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Newproject.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Newproject.view.clouddrive.CloudDrive");
    },
