...
Ext
		.define(
				'Newproject.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Newproject.view.logger.tabs.details.DetailsTab',
							'Newproject.view.logger.tabs.fileconnector.FileConnectorTab',
							'Newproject.view.logger.tabs.dbconnector.DBConnectorTab',
							'Newproject.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Newproject.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Newproject.view.logger.LogConfigurationTabPanelController',
