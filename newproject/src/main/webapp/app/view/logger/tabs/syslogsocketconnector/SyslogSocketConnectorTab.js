 ...
 * 
 */
Ext.define('Newproject.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Newproject.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
