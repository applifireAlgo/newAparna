Ext
		.define(
				'Newproject.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Newproject.view.searchengine.search.SearchEngineMainPanelController','Newproject.view.searchengine.search.PanelHeaderField' ,'Newproject.view.searchengine.search.ReportGridView','Newproject.view.searchengine.search.ReportChartView','Newproject.view.searchengine.search.documentView','Newproject.view.searchengine.search.DouMeanView','Newproject.view.googlemaps.map.MapPanel'],
