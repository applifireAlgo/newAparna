Ext.define('Newproject.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Newproject.view.searchengine.search.NorthPanel', 'Newproject.view.searchengine.search.SearchResult','Newproject.view.searchengine.search.SearchEngineMainPanelController'],
