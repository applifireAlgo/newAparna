Ext.define('Newproject.newproject.web.com.controller.organization.locationmanagement.StateMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Newproject.newproject.shared.com.model.organization.locationmanagement.StateModel',
               autoLoad: true,
