Ext.define('Newproject.newproject.web.com.controller.appbasicsetup.usermanagement.QuestionMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Newproject.newproject.shared.com.model.appbasicsetup.usermanagement.QuestionModel',
               autoLoad: true,
