Ext.define('Newproject.newproject.web.com.controller.organization.locationmanagement.TimezoneMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Newproject.newproject.shared.com.model.organization.locationmanagement.TimezoneModel',
               autoLoad: true,
