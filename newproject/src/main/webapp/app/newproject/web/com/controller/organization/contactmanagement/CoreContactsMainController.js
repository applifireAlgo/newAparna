Ext.define('Newproject.newproject.web.com.controller.organization.contactmanagement.CoreContactsMainController', {
     extend: 'Newproject.view.fw.frameworkController.AggregateViewController',
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Newproject.newproject.shared.com.model.organization.contactmanagement.CoreContactsModel',
               autoLoad: true,
