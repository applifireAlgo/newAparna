Ext.define('Newproject.newproject.web.com.controller.organization.contactmanagement.GenderMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Newproject.newproject.shared.com.model.organization.contactmanagement.GenderModel',
               autoLoad: true,
