...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "shweta.zagade@algorhythm.co.in", versionNumber = "3", comments = "Country", complexity = Complexity.LOW)
...
public class Country implements Serializable, CommonEntityInterface, Comparator<Country> {
    ...
    private static final long serialVersionUID = 1472208963760L;
