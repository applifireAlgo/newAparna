...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "shweta.zagade@algorhythm.co.in", versionNumber = "3", comments = "State", complexity = Complexity.LOW)
...
public class State implements Serializable, CommonEntityInterface, Comparator<State> {
    ...
    private static final long serialVersionUID = 1472208964885L;
