...
public class PublicApiTestCase extends EntityTestCriteria {
    ...
    private PublicApi createPublicApi(Boolean isSave) throws Exception {
        ...
        publicapi.setApiData("F8zDg2HmtZgk7uDWtXOsBtfQg5mfO5zh82xhRDwgUwJZU4cOeI");
        publicapi.setSchedulerDetails("Ba1Sw9degPjUlQn9byERR9Q2vcQKlgzrJkrEBnH1oa6IjSbHcb");
    ...
    public void test2Update() {
        try {
            ...
            publicapi.setApiData("lnbot4wAkwiEotLPmMAT5yY00ByQZHgm9ZT3CgbWdAC0XnyJWC");
            publicapi.setSchedulerDetails("hleiwbNTCUpOqzW3EqTKb47AyBSVc578nx0ukZSP5sp4SsKHEy");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 2, "apiData", ""));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 3, "schedulerDetails", ""));
