...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionDetails("MFbZEMFxxV");
        question.setQuestion("MeyF94eM8ZO6G1SIWhZML71hZEkZAvggKQldKyOLukrlLworr6");
        question.setQuestionIcon("0zcgGJdE45GUNeGbeKpenjd2RsnZQzalppoPdpaNlWIVZcQGOz");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionDetails("rHug9bGzh9");
            question.setVersionId(1);
            question.setQuestion("jXfk9rpnA9asAQc4IBqRaEnTTP7fbbuPvUI2rCcRI6RLwljM1P");
            question.setQuestionIcon("bOu1W1OQ1cg9gUAatZWadQtYwb25cRUwrIh1myf36h81UmYlXM");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "48Ec321nWJZetwnvhJlrvkSaFE71cHitv6aci40rK5umasiPpdzn0sw8opJav9cxl"));
